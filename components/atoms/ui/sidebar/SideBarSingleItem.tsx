...
export default function SideBarSingleItem(props: SideBarSingleItemProps) {
  return (
    <div
      role="button"
      className="flex items-center w-full py-3 leading-tight transition-all rounded-lg text-accent outline-none text-start hover:bg-accent hover:bg-opacity-20"
    >
